                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg w-full lg:px-[400px] md:px-10 sm:px-0 hover:bg-gradient-to-tl hover:from-gray-100 hover:to-white py-16">
                        ...
                        <div className="mt-4">
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-1 border-gray-300 border rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
